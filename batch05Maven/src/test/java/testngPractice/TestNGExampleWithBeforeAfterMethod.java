...
public class TestNGExampleWithBeforeAfterMethod {
	...
	public void sampleTest2() throws InterruptedException {
		...
		// the following element inside a frame, so first we have to change driver
		// focuse to frame then find the element
